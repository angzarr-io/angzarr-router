// Vendored from googleapis (Apache-2.0): the ErrorInfo detail message,
// field-for-field. The cross-language SCREAMING_SNAKE code travels as
// ErrorInfo.reason (domain "angzarr.io", metadata = extras map).
...
const file_google_rpc_error_details_proto_rawDesc = "" +
	...
	"\x0ecom.google.rpcB\x11ErrorDetailsProtoP\x01Z?github.com/angzarr-io/angzarr-router/bindings/go/gen/google/rpc\xa2\x02\x03GRX\xaa\x02\n" +
	"Google.Rpc\xca\x02\n" +
