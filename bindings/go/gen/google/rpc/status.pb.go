// Vendored from googleapis (Apache-2.0): the canonical google.rpc.Status
// shape, field-for-field. Vendored because the FFI error payload is
// exactly what gRPC serializes — no invented error proto.
...
const file_google_rpc_status_proto_rawDesc = "" +
	...
	"\x0ecom.google.rpcB\vStatusProtoP\x01Z?github.com/angzarr-io/angzarr-router/bindings/go/gen/google/rpc\xa2\x02\x03GRX\xaa\x02\n" +
	"Google.Rpc\xca\x02\n" +
